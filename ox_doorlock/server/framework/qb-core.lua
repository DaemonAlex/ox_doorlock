...
SetTimeout(0, function()
    ...
    -- Comment out or remove debug print statements
    -- print('Executing qb-core.lua')
    -- print('Resource Name:', resourceName)
    -- print('QB Object:', QB)
    -- print('QB Functions:', QB.Functions)
    -- print('HasGroup Function:', QB.Functions.HasGroup)

    -- Check if the HasGroup export exists
    if QB.Functions.HasGroup then
        HasGroup = QB.Functions.HasGroup
    else
        print('Error: HasGroup export not found in qb-core')
        return
    end
